...
CREATE TABLE `Casopis` (
  `idCasopis` int(11) NOT NULL,
  `ime` varchar(45) NOT NULL,
  `adresa` varchar(90) NOT NULL,
  `issnMaska` varchar(9) NOT NULL,
  `webStranica` varchar(45) DEFAULT NULL,
...
LOCK TABLES `Casopis` WRITE;
/*!40000 ALTER TABLE `Casopis` DISABLE KEYS */;
INSERT INTO `Casopis` VALUES (1,'MATFCasopis','Studentski trg 16','mjau',NULL);
/*!40000 ALTER TABLE `Casopis` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger Casopis_insert before insert on Casopis
for each row
begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 trigger Casopis_delete before delete on Casopis
for each row
begin
